...
/**
 * Implementation of the protocol {@link com.olo.plugin.PluginExecutor} that resolves
 ...
 */
public final class RegistryPluginExecutor implements com.olo.plugin.PluginExecutor {
