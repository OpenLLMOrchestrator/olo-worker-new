package com.olo.bootstrap.runtime.impl;
...
public final class OloRuntimeContextImpl implements OloRuntimeContext {
    ...
    private static PipelineDefinition resolvePipeline(PipelineDefinition fromGlobal) {
        ...
        if (!(fromGlobal instanceof com.olo.executiontree.PipelineDefinition def)) {
            return fromGlobal;
        }
        ...
        return new com.olo.executiontree.PipelineDefinition(
                def.getName(),
