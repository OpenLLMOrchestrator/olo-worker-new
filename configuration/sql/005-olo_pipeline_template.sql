...
CREATE TABLE olo_pipeline_template (
...
CREATE INDEX idx_olo_pipeline_template_region
ON olo_pipeline_template(region);

CREATE INDEX idx_olo_pipeline_template_region_pipeline
ON olo_pipeline_template(region, pipeline_id);

CREATE INDEX idx_olo_pipeline_template_active
