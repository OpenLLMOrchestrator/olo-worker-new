...
| **[how-to-debug](how-to-debug.md)** | How to run the bootstrap global-context dump test, where to find the JSON dump, and required DB schema plus SQL queries for debugging. |
