...
- **ToolProvider** (from `com.olo.tools`) is the contract; **PluginManager** exposes them so **PluginRegistry** / plugin execution can resolve and run them like other plugins.
