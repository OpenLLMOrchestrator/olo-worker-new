...
- **[configuration/sql/008-seed_global_context_us_east.sql](../../configuration/sql/008-seed_global_context_us_east.sql)** — us-east region, order-processing v2, settlement v1, tenant-A/tenant-B → us-east, tenant-A override for order-processing v2.
