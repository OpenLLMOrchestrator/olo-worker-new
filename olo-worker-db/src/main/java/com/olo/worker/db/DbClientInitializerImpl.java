...
import com.olo.configuration.port.DbClientInitializer;
import com.olo.db.DbClient;
import com.olo.db.DbClientProvider;
import com.olo.db.DbConfig;
import com.olo.db.impl.postgres.PostgresDbClient;
...
public final class DbClientInitializerImpl implements DbClientInitializer {
  ...
  private static DbClient createClient(String dbType, DbConfig dbConfig) {
    switch (dbType) {
      ...
      case "mysql":
        try {
          Class<?> clazz = Class.forName("com.olo.db.impl.mysql.MysqlDbClient");
